...
from LIPM_motion_generator.source.LIPM_function import Heaviside
from LIPM_motion_generator.source.InverseKinematics import InvK
from LIPM_motion_generator.source.Forward_Kinematics import all_transfomation_matrix
...
def OutputMotion(initR, initL, Rup, T, sampleT, dt, hip, Legs, thetaR_length,\
    ...
    init_thetas = np.array([-8.94173762e-10,  5.38954283e-09, -3.18710518e-05,  6.30069176e-05,
       -3.11603277e-05, -5.39525548e-09])
    init_thetas = np.array([0,  0,   0.4,  -0.7,  0.35,  0])
