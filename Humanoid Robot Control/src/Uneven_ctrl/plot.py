...
r_motion = pd.read_csv("Cho/return.csv",header=None,index_col=None)
# d_motion  = pd.read_csv("localcom/Cho/F2.csv",header=None,index_col=None)
d_motion  = pd.read_csv("Cho/desired.csv",header=None,index_col=None)
# ori_motion = pd.read_csv("localcom/Cho/origin.csv",header=None,index_col=None)
...
# d_motion1 = pd.read_csv("localcom/Cho/F2_1.5.csv",header=None,index_col=None)
# d_motion2 = pd.read_csv("localcom/Cho/F2_2.csv",header=None,index_col=None)
# #print每顆馬達的角度圖
# for i in range(0,12):
#     plt.subplot(2, 6, i+1)
#     # ori_motion[i].plot()
